...
class BuildSphereNeighborGpuOp : public OpKernel {
    public:
        ...
        void Compute(OpKernelContext* context) override {
            ...
            cudaMemset(nnIndex, -1, sizeof(int)*B*M*nn_sample_);
            cudaMemset(nnCount, -1, sizeof(int)*B*M);
            cudaMemset(nnDist, -1, sizeof(float)*B*M*nn_sample_);
...
class BuildCubeNeighborGpuOp : public OpKernel {
    public:
        ...
        void Compute(OpKernelContext* context) override {
            ...
            cudaMemset(nnIndex, -1, sizeof(int)*B*M*nn_sample_*2);
            cudaMemset(nnCount, -1, sizeof(int)*B*M);
